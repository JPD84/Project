...
booking1 = Booking.new({'member_id' => member1.id, 'gym_session_id' => gymsession1.id})
booking1.save

booking2 = Booking.new({'member_id' => member2.id, 'gym_session_id' => gymsession2.id})
booking2.save

booking3 = Booking.new({'member_id' => member3.id, 'gym_session_id' => gymsession3.id})
booking3.save

booking4 = Booking.new({'member_id' => member4.id, 'gym_session_id' => gymsession4.id})
booking4.save

# booking5 = Booking.new({'member_id' => member5.id, 'gym_session_id' => gymsession5.id})
# booking5.save
#
...
# booking7.save
#
# booking8 = Booking.new({'member_id' => member8.id, 'gym_session_id' => gymsession8.id})
# booking8.save
